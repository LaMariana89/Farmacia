...
<html lang="en">
  ...
  <body class="gradient text-gray-800">
    ...
    <nav class="h-30 flex justify-end py-4 px-16">
        ...
        <a href="{{route('admin.create')}}" id="navAction" class="mx-auto lg:mx-0 bg-purple-50 hover:bg-cyan-50 text-gray-800 font-extrabold rounded mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">Create</a>
    </nav>
